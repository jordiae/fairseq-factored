...
@register_model('factored_transformer_one_encoder')
class FactoredTransformerOneEncoderModel(FairseqFactoredOneEncoderModel):
    """
    ...
    def build_model(cls, args, task):
        ...
        return FactoredTransformerOneEncoderModel(encoder, decoder)
...
@register_model_architecture('factored_transformer_one_encoder', 'factored_transformer_one_encoder')
...
@register_model_architecture('factored_transformer_one_encoder', 'factored_transformer_one_encoder_iwslt_de_en')
...
@register_model_architecture('factored_transformer_one_encoder', 'test_factored_transformer_one_encoder_iwslt_de_en_babelnet')
def factored_one_encoder_iwslt_de_en(args):
...
@register_model_architecture('factored_transformer_one_encoder', 'factored_transformer_one_encoder_iwslt_de_en_babelnet_red')
def factored_one_encoder_iwslt_de_en(args):
...
@register_model_architecture('factored_transformer_one_encoder', 'factored_transformer_one_encoder_iwslt_de_en_babelnet_red_subword_tags')
def factored_one_encoder_iwslt_de_en(args):
...
@register_model_architecture('factored_transformer_one_encoder', 'factored_transformer_one_encoder_iwslt_de_en_babelnet_red256_subword_tags')
def factored_one_encoder_iwslt_de_en(args):
...
@register_model_architecture('factored_transformer_one_encoder', 'test2_factored_transformer_one_encoder_iwslt_de_en')
...
@register_model_architecture('factored_transformer_one_encoder', 'test3_factored_transformer_one_encoder_iwslt_de_en')
...
@register_model_architecture('factored_transformer_one_encoder', 'test4_factored_transformer_one_encoder_iwslt_de_en')
...
@register_model_architecture('factored_transformer_one_encoder', 'factored_transformer_one_encoder_sennrich')
def factored_one_encoder_iwslt_de_en(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
...
@register_model_architecture('factored_transformer_one_encoder', 'factored_transformer_one_encoder_sennrichS')
def factored_one_encoder_iwslt_de_en(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 1024)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
    args.encoder_embed_dim_sizes = {'de_tokensS': 362, 'de_tokensS_lemmas': 115, 'de_tokensS_pos': 10, 'de_tokensS_deps': 10, 'de_tokensS_tags': 10, 'de_tokensS_subword_tags': 5}
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 512)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 1024)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 4)
    args.decoder_layers = getattr(args, 'decoder_layers', 6)
...
@register_model_architecture('factored_transformer_one_encoder', 'factored_transformer_one_encoder_lemmas_stanfordS')
def factored_one_encoder_iwslt_de_en(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 1028)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 2056)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
    args.encoder_embed_dim_sizes = {'de_tokensS': 512, 'de_tokensS_lemmas': 512, 'de_tokensS_subword_tags': 4}
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 1028)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 2056)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 4)
    args.decoder_layers = getattr(args, 'decoder_layers', 6)
    factored_one_encoder_base_architecture(args)
