...
#SBATCH --ignore-pbs                                                            
#SBATCH --output=/home/usuaris/veu/jordi.armengol/tfg/new/logs/flores/en-ne/generate1_devtest.log
...
stdbuf -i0 -e0 -o0 $PYTHON $FAIRSEQ_DIR/generate.py $DEST_DIR --path $CP_DIR/$CP \
	--beam 5 --lenpen 1.2 --gen-subset test --source-lang ${SRC} --target-lang ${TGT} --task translation --remove-bpe=sentencepiece
