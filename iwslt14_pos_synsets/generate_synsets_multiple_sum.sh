...
#SBATCH --ignore-pbs                                                            
#SBATCH --output=/home/usuaris/veu/jordi.armengol/tfg/new/logs/generate20-no-average-synsets-multiple-sum.log
...
stdbuf -i0 -e0 -o0 $PYTHON $FAIRSEQ_DIR/generate.py $DEST_DIR --path $CP_DIR/$CP \
	--beam 5 --batch-size 1 --lang-pairs de-en,de_synsets_at-en --task factored_translation --remove-bpe --target-lang en --multiple-encoders True
