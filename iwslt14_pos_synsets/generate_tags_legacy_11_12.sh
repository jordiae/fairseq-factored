...
#SBATCH --ignore-pbs                                                            
#SBATCH --output=/home/usuaris/veu/jordi.armengol/tfg/new/logs/generate13-one-encoder-no-average.log
...
stdbuf -i0 -e0 -o0 $PYTHON $FAIRSEQ_DIR/generate.py $DEST_DIR --path $CP_DIR/$CP \
	--beam 5 --batch-size 1 --lang-pairs de-en,de_postags_at-en --task factored_translation --remove-bpe --model-overrides "{'factor': 'de_postags_at', 'multiple_encoders': 'True', 'factor_encoder_embed_dim': 32}"
