...
#SBATCH --ignore-pbs                                                            
#SBATCH --output=/home/usuaris/veu/jordi.armengol/tfg/new/logs/new_islt14_scripts/generate35_one_lemmas10k_concat_tokensS.log
...
stdbuf -i0 -e0 -o0 $PYTHON $FAIRSEQ_DIR/generate.py $DEST_DIR --path $CP_DIR/$CP \
	--beam 5 --batch-size 1 --lang-pairs de_tokensS-en,de_tokensS_lemmas-en,de_tokensS_subword_tags-en --task factored_translation --remove-bpe --target-lang en --multiple-encoders False
