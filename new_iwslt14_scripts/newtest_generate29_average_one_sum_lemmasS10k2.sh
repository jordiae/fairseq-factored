...
#SBATCH --ignore-pbs                                                            
#SBATCH --output=/home/usuaris/veu/jordi.armengol/tfg/new/logs/new_islt14_scripts/newtest-generate29-average-lemmasS-10k-one-sum2.log


WORKING_DIR="/home/usuaris/veu/jordi.armengol/tfg/new/data/iwslt13-preprocessed-joined-stanford"
#SRC="de"
#TGT="en"
