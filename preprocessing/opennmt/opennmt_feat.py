...
def format_opennmt(text_bpe, text_lemma, text_pos, text_dep, text_tag):
    sep = '\uFFE8'
    res = ''
    for line_bpe, line_lemma, line_pos, line_dep, line_tag in zip(text_bpe.splitlines(), text_lemma.splitlines(), text_pos.splitlines(), text_dep.splitlines(), text_tag.splitlines()):
